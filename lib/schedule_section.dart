                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            _buildSettingsOption(
                              ...
                              onTap: () {
                                Navigator.pop(context);
                                _showPrivacySecurityBottomSheet(context);
                              },
                            ),
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      _buildApiKeyCard(
                        ...
                        onEdit:
                            () =>
                                _showEditApiKeyDialog(context, 'OpenAI GPT-4'),
                        onDelete:
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: const Icon(Icons.api, size: 20, color: Color(0xFF007AFF)),
            ),
            const SizedBox(width: 12),
                        ...
                        child: ListView(
                          ...
                          children: [
                            _buildModelSelectionCard(
                              ...
                              description:
                                  'For creating routine descriptions and suggestions',
                              currentModel: 'GPT-4',
                            ...
                            _buildModelSelectionCard(
                              ...
                              description:
                                  'For analyzing and improving your habits',
                              currentModel: 'GPT-4',
                              icon: Icons.psychology_outlined,
                          ...
                          children: [
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                filled: true,
                                fillColor: ThemeProvider.getSecondaryTextColor(
                                  context,
                                ).withOpacity(0.1),
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            Text(
                              'Your privacy is important to us. ScheduleMe is designed with privacy in mind and follows these principles:\n\n'
                              '• Data Collection: We only collect the minimum data necessary to provide our services, such as your routine schedules and preferences.\n\n'
                              '• Data Storage: All your personal data is stored locally on your device. We do not store your personal information on external servers without your explicit consent.\n\n'
                              '• Data Sharing: We do not sell, trade, or share your personal information with third parties for marketing purposes.\n\n'
                              '• Analytics: We may collect anonymous usage statistics to improve the app, but this data cannot be used to identify you personally.\n\n'
                              '• Third-party Services: If you choose to use cloud sync features, your data will be processed according to the respective cloud provider\'s privacy policy.',
                              style: TextStyle(
                                fontSize: 14,
                                color: ThemeProvider.getTextColor(context),
                                height: 1.5,
                            ...
                            Text(
                              ...
                              '• App Lock: You can enable biometric authentication (Face ID, Touch ID, or PIN) to protect access to your schedules.\n\n'
                              '• Secure API: All communications with external services use secure HTTPS connections with certificate pinning.\n\n'
                              '• Regular Updates: We regularly update our security measures and promptly address any discovered vulnerabilities.\n\n'
                              '• Data Backup: Local backups are encrypted and can only be restored on your authorized devices.',
                              style: TextStyle(
                                fontSize: 14,
                                color: ThemeProvider.getTextColor(context),
                                height: 1.5,
                            ...
                            const SizedBox(height: 8),
                            Text(
                              'If you have any questions about our privacy practices or security measures, please contact us at privacy@scheduleme.app',
                              style: TextStyle(
                                fontSize: 14,
                                color: ThemeProvider.getSecondaryTextColor(
                                  context,
...
class _CreateRoutineBottomSheetState extends State<_CreateRoutineBottomSheet> {
          ...
          (context, scrollController) => Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 32), // Scrollable content
                Expanded(
                  child: ListView(
                    controller: scrollController,
                    padding: const EdgeInsets.symmetric(horizontal: 20),
                    children: [
                      // Days section (moved to top)
                      ...
                      // Time section (iOS style)
                      _buildSectionTitle('Time'),
                      const SizedBox(height: 8),
                      _buildIOSTimeSelector(),
                      const SizedBox(height: 40),
                    ],
                  ),
                ),
  ...
  Widget _buildTextField({
    ...
    final textColor = isDark ? Colors.white : const Color(0xFF1C1C1E);
    final hintColor = const Color(0xFF8E8E93);
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Text('End', style: TextStyle(fontSize: 16, color: textColor)),
                  const Spacer(),
                  Text(
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            timePickerTheme: TimePickerThemeData(
              ...
              dayPeriodColor: const Color(0xFF007AFF).withOpacity(0.1),
              dialHandColor: const Color(0xFF007AFF),
              dialTextColor: isDark ? Colors.white : const Color(0xFF1C1C1E),
  ...
  Future<void> _saveRoutine() async {
    ...
    try {
      final routine = ScheduleItem(
        ...
        const Color(0xFF007AFF), // Default iOS blue color
